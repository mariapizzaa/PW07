...
# --- 1. DATASET LOADING ---
# Percorsi assoluti dei file Excel
filename_TD = "/Users/vittoria/Desktop/NEUROENGINEERING/PROGETTO/METRICHE/results_cones_2D_TD_unlabelled_20_10_2025_after.xlsx"
filename_ASD = "/Users/vittoria/Desktop/NEUROENGINEERING/PROGETTO/METRICHE/results_cones_2D_ASD_unlabelled_31_10_2025_after.xlsx"

# Caricamento dataset direttamente dai percorsi assoluti
df_TD = pd.read_excel(filename_TD)
df_ASD = pd.read_excel(filename_ASD)
...
def preprocess_data_final(df_input, group_name):
    ...
    for col in cols_to_interpolate:
        if col in df_clean.columns:
            try:
                df_clean[col] = medfilt(df_clean[col].values, KERNEL_SIZE)
...
print("\nAll done! Cleaned files saved as TD_cleaned.xlsx and ASD_cleaned.xlsx.")
